...
public class boxWinCon : MonoBehaviour {
	...
	void Update () {
        /*Debug.Log(blackbox1.GetComponent<Move>().wincon.ToString() +
          ...
          if (  blackbox1.GetComponent<Move>().wincon == true &&
                blackbox2.GetComponent<Move>().wincon == true &&
                blackbox3.GetComponent<Move>().wincon == true &&
                blackbox4.GetComponent<Move>().wincon == true &&
                blackbox5.GetComponent<Move>().wincon == true &&
                blackbox6.GetComponent<Move>().wincon == true)
        {
            if (text != null)
                text.text = "SUCCESS!";
            if (part != null)
